...
TOKEN = os.getenv("8163972507:AAEL9ZSxZzaifHM-fGuG29APu6yp5s0tjS8")
URL = f"https://api.telegram.org/bot{TOKEN}/"
ADMIN_ID = 6688570192  # Sizning Telegram ID'ingiz

app = Flask(__name__)

POEM_FILE = "/data/poems.json"  # Fly.io volume ichida
...
def webhook():
    ...
    if "message" in data:
        ...
        if text == "/start":
            if chat_id == ADMIN_ID:
                keyboard = {"keyboard":[[{"text":"📜 She’rlar ro‘yxati"}],[{"text":"📥 Yangi she’r qo‘shish"}]],"resize_keyboard":True}
...
if __name__ == "__main__":
    # 🔥 Muhim: Fly.io uchun 0.0.0.0:8080 da ishlaydi
